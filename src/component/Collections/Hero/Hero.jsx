    ...
    <section className="md:basis-1/2 lg:basis-3/5">
      <div className="text-white pt-4 pb-8 px-7 font-work-sans flex flex-col gap-2">
        ...
        <div className="created-by">
          <span className="py-2 text-[#858584] font-space-mono">
            Created By
          </span>
        ...
        <div className="description">
          <span className="py-4 capitalize text-[#858584] font-space-mono">
            description
          </span>
        ...
        <div className="details">
          ...
          {links.map((link, index) => (
            <div
              key={index}
              className="pt-2 flex items-center gap-2 text-[#858584]"
            >
              <FiGlobe />
