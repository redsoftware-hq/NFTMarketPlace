							...
							<div className="container-div mt-24 md:mt-[20rem]">
								...
								<div className="container-2 grid grid-cols-1 md:grid-cols-2 text-white mt-10 gap-5">
									<div className="space-y-10 w-full">
										...
										<button className="py-5 px-16 hidden md:flex items-center bg-[#ffff] hover:bg-[#3b3b3b] border-2 border-[#F15623] hover:text-white ease-in-out duration-300 rounded-2xl capitalize text-black text-lg font-semibold gap-3">
