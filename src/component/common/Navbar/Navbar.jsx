        ...
        <div className="hidden lg:flex">
          <div className="text-white flex items-center gap-5 font-medium font-work-sans space-x-5">
            ...
            <div className="flex justify-between items-center gap-2">
              <div className="bg-[#F15623] py-4 px-7 rounded-2xl flex items-center gap-2 border-2 border-[transparent] hover:border-[#F15623] hover:bg-transparent duration-300">
