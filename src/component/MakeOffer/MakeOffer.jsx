...
function MakeOffer({ nft }) {
  return (
    <div className="p-2 flex flex-col gap-3 w-full">
      ...
      <div className="text-[#858584] font-space-mono text-sm flex flex-wrap gap-2 items-center justify-between max-w-[415px] w-full">
        <h1 className="text-white text-3xl">{nft.price} ETH</h1>
