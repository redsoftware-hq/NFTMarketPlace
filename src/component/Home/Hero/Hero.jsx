				...
				<div className="flex justify-between flex-col md:flex-row gap-10">
					<div className="space-y-5 flex flex-1 flex-col">
						...
						<p className="capitalize text-md font-work-sans text-white">
							New Marketplace by Metajuice. Collect, Buy And Sell Art From More
						...
						<div className="flex flex-1 items-end justify-between text-white font-light capitalize font-work-sans text-lg pt-7">
							<p className="">
								<span className="text-2xl font-space-mono">243k+</span> <br />{" "}
								Total Sale
							</p>
							<p className="">
								<span className="text-2xl font-space-mono">109k+</span> <br />{" "}
								Auctions
							</p>
							<p className="">
								<span className="text-2xl font-space-mono">152k+</span> <br />{" "}
								Artists
							</p>
						</div>
					</div>
