...
const CollectionCard = ({ item, key }) => {
	return (
		<div
			className={`${key} card-1 grid grid-flow-row max-w-[320px] max-h-[525px] gap-2`}
		>
			<div className="grid min-w-80 transition-all duration-300 hover:scale-110 hover:my-5">
